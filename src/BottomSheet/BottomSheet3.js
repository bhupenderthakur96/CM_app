...
const BottomSheet3 = ({ setStatus }) => {
    ...
    return (
        <Pressable onPress={closeModal} style={styles.backdrop}>
            <Pressable style={{ width: '100%', height: '62%',paddingHorizontal:responsiveWidth(2) }}>
  ...
  >
                    <View style={{flex: 1, height:responsiveHeight(0.3), backgroundColor: 'black',marginHorizontal:responsiveWidth(40)}}  />
                        ...
                        style={{
                            ...
                            <Text style={{alignSelf:"center",paddingHorizontal:responsiveWidth(5)}}>Job pickup image</Text>
                            <Image
                               style={{
