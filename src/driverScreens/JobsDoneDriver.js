...
const JobsDoneDriver = ({ navigation }) => {
      ...
      <TouchableOpacity onPress={onPress}>
        <View
          ...
          <View style={{
            ...
            <Text style={{bottom:responsiveHeight(0.3),  color: "#0D1B25", fontFamily: "Poppins-Regular", fontSize: responsiveFontSize(1.5), }}>Job Efficiency: <Text style={{color:"#27AE60",fontFamily: "Poppins-Bold"}}>85%</Text></Text>
            <Text style={{bottom:responsiveHeight(0.6),  color: "#0D1B25", fontFamily: "Poppins-Regular", fontSize: responsiveFontSize(1.5), }}>March15, 2023 1:24pm</Text>
            </View>
          </View>
        </View>
      </TouchableOpacity>
  ...
  return (
    <View style={styles.container}>
      <FlatList
        data={DATA}
        renderItem={({ item }) => <Item title={item} onPress={() => navigation.navigate('CompleteJobDes')} />}
